...
namespace app
{
	class CModernGraphicsRendererAdapter : public graphics_lib::CCanvas, modern_graphics_lib::CModernGraphicsRenderer
	{
	public:
		CModernGraphicsRendererAdapter() :
			modern_graphics_lib::CModernGraphicsRenderer(cout),
	...
	void PaintPictureOnModernGraphicsRenderer()
	{
		...
		CModernGraphicsRendererAdapter adapter;
